...
function playOnTheAudio() {
	...
	speechButton.on('click', function (e) {
		...
		if (audioElement.paused || audioElement.ended) {
			...
			if (isValid) {
				var apiRequest = '/api/speech?speaker_id=' + speechRequest.speaker_id + '&text=' + encodeURIComponent(speechRequest.text) + '&speeking_rate=' + speechRequest.speeking_rate + '&emotion=' + speechRequest.emotion;
	...
	speechButton.on('click', function (e) {
		...
		if (!playingFlag) {
			...
			if (isValid) {
				...
				var audioBuffer;
				// APIリクエストURL
				var synthesizerUrl = '/api/speech?speaker_id=' + speechRequest.speaker_id + '&text=' + encodeURIComponent(speechRequest.text) + '&speeking_rate=' + speechRequest.speeking_rate + '&emotion=' + speechRequest.emotion;
